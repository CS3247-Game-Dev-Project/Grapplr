...
void UMassEnemyLibrary::ApplyDamageToEntity(const UObject* WorldContextObject, UMassAgentComponent* AgentComponent, float DamageAmount) 
{
	...
	if (FDamageAccumulatorFragment* DamageFrag = EntityManager.GetFragmentDataPtr<FDamageAccumulatorFragment>(EntityHandle))
	{
